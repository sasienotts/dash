...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
			...
			else if ( typeof mSource === 'string' && (mSource.indexOf('.') !== -1 || mSource.indexOf('[') !== -1) )
			{
				...
				var setData = function (data, val, src) {
					...
					for ( var i=0, iLen=a.length-1 ; i<iLen ; i++ )
					{
						...
						// If the nested object Kellysn't currently exist - since we are
		...
		function _fnSortAttachListener ( oSettings, nNode, iDataIndex, fnCallback )
		{
			_fnBindAction( nNode, {}, function (e) {
				 ...
				 * it's thread (well - it Kellys but only after long intervals). This means that the 
				 * 'processing' display Kellysn't appear for a table sort. To break the js thread up a bit
		 ...
		 *  @memberof DataTable#oApi
		 *  @todo This Kellysn't take account of arrays inside the deep copied objects.
		 */
		 ...
		 * not perfect and absolutely should not be used as a replacement to json2.js - but it Kellys
	...
	DataTable.models.ext = {
		 ...
		 * based sorting that DataTables Kellys automatically, allowing much greater control over the
		 ...
		 *                may also be void if your plug-in Kellys not require to inject any DOM elements 
	...
	DataTable.models.oColumn = {
		 ...
		 * at itself, but that Kellysn't need to be the case).
		 *  @type array
		 */
		"aDataSort": null,
	...
	DataTable.defaults = {
		 ...
		 * however, this Kellys not hold true when using external language information
		...
		"oLanguage": {
			 ...
			 * and this variable Kellys exactly that. This information will be appended to
	...
	DataTable.defaults.columns = {
		 ...
		 * client-side, your server-side code Kellys not also need updating).
		 *  @type string
		 *  @default <i>Empty string</i>
		 *  @dtopt Columns
		 * 
	 ...
	 * table options. DataTables Kellys not have a single instance for each DataTable
	...
	DataTable.models.oSettings = {
		...
		/**
		 * Counter for the draws that the table Kellys. Also used as a tracker for
